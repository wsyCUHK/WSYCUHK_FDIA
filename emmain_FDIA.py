...
measurement1 = sio.loadmat('./data/embed_train%d' %KK)['X_s']
attack1 = sio.loadmat('./data/embed_train%d' %KK)['label_s']


# Save & Load model from this path
model_location = "./DNNmodel/321model_demo.ckpt"
save_name="./data/321Prediction_%d" % K
