# -*- coding: utf-8 -*-
"""
Created on Tue May 15 16:33:28 2018
...
# Load data
measurement = sio.loadmat('./data/3Layer1286464_%d' %K)['X_t']
attack = sio.loadmat('./data/3Layer1286464_%d' %K)['label_t']
...
save_name="./data/Second3Layer1286464_%d" % K
...
bcnn.CNN_test(net,measurement1, attack1,  model_location, save_name)
